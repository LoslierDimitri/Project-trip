...
insert into projet_trip.specialities(noms, images, descriptions, idregions) values ("Les accras",  "accras.jpg", "Les accras Pour les néophytes, les accras sont comme des petits beignets salés, généralement à la morue, mais aussi aux légumes. Mais le top des accras, c’est la version crevette, qu’on n’a souvent pas envie de partager.", 14); 
insert into projet_trip.specialities(noms, images, descriptions, idregions) values ("Les bokits",  "bokit.jpg", "Un sandwich frit, fourré à la morue, au poulet ou encore au jambon-fromage, dans la version simple, qu’on mange à la plage ou en bord de route après une journée de randonnée en Guadeloupe. Miam miam !", 14);
insert into projet_trip.specialities(noms, images, descriptions, idregions) values ("Le colombo de cabri", "colombo.jpg", "D’influences indienne, le colombo est une sauce à base de poudre à colombo, de bois d’inde, de pomme de terre et d’aubergine, dans laquelle on fait mijoter du cabri, notre chèvre locale, avant de servir le tout avec du riz blanc.", 14);
insert into projet_trip.specialities(noms, images, descriptions, idregions) values ("Le tourment d'amour", "tourment-amour.jpg","Dès votre arrivée en bateau aux Saintes, des marchands vous proposeront ces gâteaux mous sur une base de pâte brisée, fourrés à la confiture tantôt de goyave, tantôt de coco ou de banane.", 14);
...
insert into projet_trip.visits(noms, images, descriptions, idregions) values ("La Soufrière", "soufrière.jpg", "La Soufrière est le mont le plus haut parmi ceux toutes les îles des Antilles. Vous pouvez grimper ses 1400 mètres d'altitude au cours d'une magnifique randonnée.", 14);
insert into projet_trip.visits(noms, images, descriptions, idregions) values ("Saint-Francois", "saint-francois.jpg", "Une excursion à Saint-François est un lieu très prisé pour ses restaurants antillais et ses restos-bars où vous pourrez déguster une bonne glace dans une ambiance décontractée, au son des concerts de musiciens locaux.", 14);
insert into projet_trip.visits(noms, images, descriptions, idregions) values ("Les Chutes du Carbet", "chute_du_carbet.jpg", "Le Grand Carbet est une rivière qui prend sa source à 1300 mètres d’altitude au volcan de la Soufrière. Elle dévale les pentes du parc national en formant trois impressionnantes cascades, puis finit par se jeter dans la mer, 11 km plus bas.", 14);
insert into projet_trip.visits(noms, images, descriptions, idregions) values ("Les Bains Jaunes", "bains-jaunes-soufrière.jpg", "En Basse Terre, vous trouverez de nombreuses sources d’eau chaude sulfureuse, émanant du volcan la Soufrière. Les Bains Jaunes en font partie : un patrimoine naturel qui fait la fierté des Guadeloupéens et aussi le bonheur des randonneurs!", 14); 
