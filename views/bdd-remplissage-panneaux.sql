...
insert into projet_trip.regions(noms) values("Grand-Est");
insert into projet_trip.regions(noms) values("Nouvelle Aquitaine");
insert into projet_trip.regions(noms) values("Auvergne-Rhône-Alpes");
insert into projet_trip.regions(noms) values("Bourgogne-Franche-Comté");
insert into projet_trip.regions(noms) values("Centre-Val de Loire");
insert into projet_trip.regions(noms) values("Corse");
insert into projet_trip.regions(noms) values("Occitanie");
insert into projet_trip.regions(noms) values("Île-de-France");
insert into projet_trip.regions(noms) values("Hauts-de-France");
insert into projet_trip.regions(noms) values("Normandie");
insert into projet_trip.regions(noms) values("Grand-Est");
insert into projet_trip.regions(noms) values("Provence-Alpes-Côte-d'Azur");
insert into projet_trip.regions(noms) values("Bretagne");
...
insert into projet_trip.specialities(noms, images, descriptions, idregions) values ("L'anchoïade", "Anchoïade.jpg", "L'anchoïade est ce que l'on sert le plus souvent lors d'un apéritif pour une mise en bouche légère et fraîche. C'est en réalité une crème d'anchois dans laquelle on trempe des morceaux de légumes crus ou du pain", 12);
...
select * from projet_trip.specialities;
