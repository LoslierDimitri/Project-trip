...
<head>
    ...
    <link rel="stylesheet" href="/Project-trip/View/css/page_mentions_legales.css">
...
<img class="w-100 my-4" src="/Project-trip/View/png/banner-mentions-legales.png" alt="" srcset="">


<?php
    $path = $_SERVER["DOCUMENT_ROOT"];
    $path_new = $path . "/Project-trip/View/component/mentions_legales.php";
    include($path_new);
    ?>
